...
@Autonomous
public class DaddyTrump extends LinearOpMode {
    OpenCvCamera camera;
...
//        chainBar.setTargetPosition(ARM_0);
        ...
        if (zone == 1) {
            Actions.runBlocking(drive.actionBuilder(new Pose2d(12, -63, Math.toRadians(270)))
                    ...
                    .strafeToLinearHeading(new Vector2d(2.43, -31.23), Math.toRadians(300))
...
//
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    .strafeToLinearHeading(new Vector2d(52.05, -29.5),  Math.toRadians(180.00))
                    .build());
            backLeg.setPosition(.84);  // .9 is closed pos
            sleep(50);
            ...
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    ...
                    .splineToConstantHeading(new Vector2d(-55.66,-14.3),Math.toRadians(180))
                    .build());
            intake.setPower(-1);
            sleep(850);
            Actions.runBlocking(drive.actionBuilder(drive.pose)
...
//            hips.setPosition(.18); hips hips hips hips
                    ...
                    .splineToConstantHeading(new Vector2d(54.75,-31.7),Math.toRadians(315))
                    .build());
            intake.setPower(0);
//            sleep(300);
//            hips.setPosition(.18);
            ...
            arch.setPosition(.972);
            sleep(150);
            rightWinch.setTargetPosition(-30);
            rightWinch.setPower(1);
            leftWinch.setTargetPosition(-30);
            leftWinch.setPower(1);
            hips.setPosition(.23);
            sleep(200);
            backLeg.setPosition(.84);  // .9 is closed pos
            ...
            sleep(100);
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    .splineToConstantHeading(new Vector2d(16.23,-10.55),Math.toRadians(191))
...
//            hips.setPosition(.18); hips hips hips hips
            ...
            sleep(200);
            //intake.setPower(0);
            sneakyLink.setPosition(.63); //weirdo position la la lala la
            sneakyRink.setPosition(.37);
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    .splineToConstantHeading(new Vector2d(16.23,-10.55),Math.toRadians(191)) //16.23
                    .splineToConstantHeading(new Vector2d(-55.9,-13.7),Math.toRadians(180)) //55.56, 14.3
                    .build());
            intake.setPower(-1);
            sleep(850);
            Actions.runBlocking(drive.actionBuilder(drive.pose)
...
//            hips.setPosition(.18); hips hips hips hips
                    ...
                    .splineToConstantHeading(new Vector2d(54.75,-29.7),Math.toRadians(315))
                    .build());
            intake.setPower(0);
//            sleep(300);
//            hips.setPosition(.18);
...
//            hips.setPosition(.18); hips hips hips hips
            ...
            Actions.runBlocking(drive.actionBuilder(new Pose2d(12, -63, Math.toRadians(270)))
                    .strafeToConstantHeading(new Vector2d(23.53, -40)) //40
            ...
            arch.setPosition(.771);
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    .strafeToLinearHeading(new Vector2d(52.05, -44.19), Math.toRadians(180.00)) //backdrop location
                    .build());
            backLeg.setPosition(.84);  // .9 is closed pos
            sleep(50);
            frontLeg.setPosition(.2);
...
//            hips.setPosition(.18); hips hips hips hips
        ...
        if (zone == 1) {
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    .strafeTo(new Vector2d(51.5, -29.7))
                    .build());
            backLeg.setPosition(.84);  // .9 is closed pos
            sleep(50);
            frontLeg.setPosition(.2);
