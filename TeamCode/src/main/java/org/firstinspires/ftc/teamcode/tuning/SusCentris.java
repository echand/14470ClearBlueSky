...
@Autonomous
public class SusCentris extends LinearOpMode {
    OpenCvCamera camera;
...
//        chainBar.setTargetPosition(ARM_0);
        ...
        if (zone == 1) {
            Actions.runBlocking(drive.actionBuilder(new Pose2d(12, -63, Math.toRadians(270)))
                    .strafeToLinearHeading(new Vector2d(9, -42.43), Math.toRadians(300))
                    .build());
        } else if (zone == 2) {
            Actions.runBlocking(drive.actionBuilder(new Pose2d(12, -63, Math.toRadians(270)))
                    .strafeTo(new Vector2d(13, -34)).build());
        } else {
            Actions.runBlocking(drive.actionBuilder(new Pose2d(12, -63, Math.toRadians(270)))
                    .strafeToConstantHeading(new Vector2d(15, -44.00))
                    .strafeToLinearHeading(new Vector2d(18, -37.43), Math.toRadians(210))
                    .strafeToConstantHeading(new Vector2d(30, -34.33))
                    .build());
        }
