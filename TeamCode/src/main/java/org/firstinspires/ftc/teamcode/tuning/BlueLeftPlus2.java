...
@Autonomous
public class BlueLeftPlus2 extends LinearOpMode {
    OpenCvCamera camera;
...
//        chainBar.setTargetPosition(ARM_0);
        ...
        if (zone == 1) {
            ...
            arch.setPosition(.363);
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    .strafeToLinearHeading(new Vector2d(52.05, 35.7),  Math.toRadians(180.00))
                    .build());
            backLeg.setPosition(.76);  // .9 is closed pos
            sleep(50);
            frontLeg.setPosition(.52);
            ...
            Actions.runBlocking(drive.actionBuilder(drive.pose)
                    ...
                    .splineToConstantHeading(new Vector2d(54,29.7),Math.toRadians(45))
                    .build());
            intake.setPower(0);
            backLeg.setPosition(.82);
            frontLeg.setPosition(.62);
